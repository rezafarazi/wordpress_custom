...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	<div id="login">
		<center>
            <img src="http://sorapp.ir/wp-content/themes/Sorapp/Img/Logo.png" width="75px"/>
            <br>
            <br>
        </center>
	<?php
...
<link href="wp-content/themes/Sorapp/Img/Logo.png">
...
<style>
    ...
    {
        font-family: 'Vazir';
        src: url("wp-content/themes/Sorapp/Fonts/Vazir.ttf");
    }
    ...
    *
    ...
    input,#user_login,#user_pass,#user_email
    {
        outline: none;
        width: 100%;
        border-radius: 5px;
    ...
    #user_login,#user_pass,#user_email
    {
        ...
        border: none;
        background: #FFF;
        border-bottom: 2px solid #ed555a;
        box-shadow: none;
    }
